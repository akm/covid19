<template>
  <div class="About">
    ...
    <TextCard>
      {{
        $t(
          '当サイトは栃木県県北地域の新型コロナウイルス感染症 (COVID-19) に関する情報を提供するために、株式会社テクノ産業によって開設された非公式なサイトです。'
        )
      }}<br /><br />
      <i18n
      ...
      >
        <a
          ...
          place="parent_site"
        >
          {{ $t('栃木県県北地域 非公式新型コロナウイルス対策サイト') }}
        </a>
        <a
          href="https://github.com/tecowl/covid19"
          target="_blank"
          rel="noopener"
      ...
      {{
        $t(
          '栃木県の公式発表情報を元に、数値をわかりやすく伝えることで、栃木県北部にお住まいの方や、県北地域に拠点を持つ企業の方、訪れる方が、現状を把握して適切な対策を取れるようにすることを目的としています。'
        )
      }}
      <br /><br />
      {{
        $t(
          '当サイトは栃木県や各市町村の自治体と直接関係のない、那須塩原市のIT企業である株式会社テクノ産業によって運営されていおります。本サイトの内容に関して各自治体への問合わせ等はご遠慮願います。'
        )
      }}
    </TextCard>
